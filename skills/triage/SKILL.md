...
These are canonical role names — the actual label strings used in the issue tracker may differ. The mapping lives in `docs/agents/triage-labels.md` — run `/setup-workflow` if it isn't there yet.
